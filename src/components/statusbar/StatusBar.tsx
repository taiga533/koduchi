...
import { ArrowLeftRight, ChevronUp, Lock, Settings, Unplug } from 'lucide-react'
...
export function StatusBar({ onOpenSettings, onDisconnect, onSwitchConnection }: StatusBarProps) {
